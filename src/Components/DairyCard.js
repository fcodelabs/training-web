...
function DairyCard({title,subtitle,description}) {
    ...
    const displayDescription= description.length > 20?(readMore? description.slice(0,20)+"...":description):description;
    const onClick=()=>{
    ...
    return (
        ...
        <CardActions>
        {description.length > 20?(<Button text={readMore?"read more":"read less"} onClick={onClick}/>):""}
