...
const NewCard = () => {
  ...
  const submitHandler = (e) => {
    ...
    if (title === "" && description === "") {
      ...
      let arr = [...titleArray];
      arr.push({ name: title, description: description, showMore: false });
                    ...
                    <CardActions>
                      ...
                      <button
                        onClick={() => {
                          setTitleArray(
                            titleArray.map((txt) => {
                              if (txt.description == data.description) {
                                return { ...txt, seeMore: !data.seeMore };
                              }
                              return txt;
                            })
                          );
                      ...
                      >
                        {!data.seeMore ? "...Show more" : "...Show less"}
                      </button>
                    </CardActions>
                  </Card>
                </Box>
